...
Donate link: http://webdorado.org/products/wordpress-menu-vertical.html
...
####[WordPress vertical menu](http://webdorado.org/products/wordpress-menu-vertical.html)

Folder Menu Vertical is a flash dynamic menu module for your WordPress 3.0+ website, designed to meet your needs and preferences. 

[Demo](http://wpdemo.webdorado.org/folder-menu-vertical/)  
[Support Forum](http://webdorado.org/forum/folder-menu.html)  
[FAQ](http://webdorado.org/forum/folder-menu/4-folder-menu-faq.html)  
...
*   Nice Flash effects
*   Interface fully integrated with WordPress administration, which allows to use [WordPress vertical menu](http://webdorado.org/products/wordpress-menu-vertical.html) with new or existing menus of WordPress.
...
####Thank you for your interest in [WordPress vertical menu](http://webdorado.org/products/wordpress-menu-vertical.html).
...
[Visit FAQ section on webdorado.org](http://webdorado.org/forum/folder-menu/4-folder-menu-faq.html)
...
Yes, there is an option in [WordPress vertical menu](http://webdorado.org/products/wordpress-menu-vertical.html) to set the position fixed or unfixed while scrolling.     
...
We did our best to have a universal product which will work on any browser, template and will not conflict with other extensions. As any case of such kind of a problem  is unique, please contact us giving the link of the website where the problem has occurred and [WordPress vertical menu](http://webdorado.org/products/wordpress-menu-vertical.html) is installed. We will try to answer within 24 hours.    
...
== Screenshots ==
1.  [WordPress vertical menu](http://webdorado.org/products/wordpress-menu-vertical.html)
2.  [WordPress vertical menu](http://webdorado.org/products/wordpress-menu-vertical.html)
...
1.1 Minimum requirements of using [WordPress vertical menu](http://webdorado.org/products/wordpress-menu-vertical.html).                        
*	Wordpress 3.0+  
*	PHP 5.x  
*	MySQL 5.x  
...
5.	If the installation of Folder Menu succeeded you will see the message in the picture. If any problem occurs with the installation of [WordPress vertical menu](http://webdorado.org/products/wordpress-menu-vertical.html), please contact us info@webdorado.org.  
